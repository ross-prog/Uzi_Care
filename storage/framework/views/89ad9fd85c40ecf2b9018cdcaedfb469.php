    ...
    <div class="form-container">
        ...
        <table class="section-table">
            ...
            <tr>
                ...
                <td class="field-value medium-col"><?php echo e($record->student_employee_id); ?></td>
                <td class="field-label narrow-col">Date and Time:</td>
                <td class="field-value wide-col" colspan="3"><?php echo e(\Carbon\Carbon::parse($record->consultation_date_time)->format('m/d/Y g:i A')); ?></td>
            </tr>
            <tr>
                <td class="field-label">Last Name:</td>
                <td class="field-value"><?php echo e($record->last_name); ?></td>
                <td class="field-label">First Name:</td>
                <td class="field-value"><?php echo e($record->first_name); ?></td>
                <td class="field-label">Middle Name:</td>
                <td class="field-value"><?php echo e($record->middle_name); ?></td>
            </tr>
            <tr>
                <td class="field-label">Age:</td>
                <td class="field-value"><?php echo e($record->age); ?></td>
                <td class="field-label">Birthdate:</td>
                <td class="field-value"><?php echo e(\Carbon\Carbon::parse($record->birthdate)->format('m/d/Y')); ?></td>
                <td class="field-label">Civil Status:</td>
                <td class="field-value"><?php echo e($record->civil_status); ?></td>
            </tr>
            <tr>
                <td class="field-label">Sex:</td>
                <td class="field-value"><?php echo e($record->sex); ?></td>
                <td class="field-label">Address:</td>
                <td class="field-value" colspan="3"><?php echo e($record->address); ?></td>
            </tr>
            <tr>
                <td class="field-label">Department/Course:</td>
                <td class="field-value" colspan="2"><?php echo e($record->department_course); ?></td>
                <td class="field-label">Contact No.:</td>
                <td class="field-value" colspan="2"><?php echo e($record->contact_no); ?></td>
            </tr>
            <?php if($record->guardian_name): ?>
            <tr>
                <td class="field-label">Name of Guardian:</td>
                <td class="field-value" colspan="2"><?php echo e($record->guardian_name); ?></td>
                <td class="field-label">Relationship:</td>
                <td class="field-value"><?php echo e($record->guardian_relationship); ?></td>
                <td class="field-value"><?php echo e($record->guardian_contact_no); ?></td>
            </tr>
            <?php endif; ?>
            <tr>
            ...
            <tr>
                <td class="field-value complaints-section" colspan="6"><?php echo e($record->chief_complaints); ?></td>
            </tr>
        </table>
        ...
        <table class="section-table">
            ...
            <tr>
                <td style="width: 25%;">
                    <div class="checkbox-row">
                        <input type="checkbox" <?php echo e($record->has_allergy ? 'checked' : ''); ?>>
                        <span>Allergy:</span>
                    </div>
                ...
                <td style="width: 25%;">
                    <div class="checkbox-row">
                        <input type="checkbox" <?php echo e($record->has_hypertension ? 'checked' : ''); ?>>
                        <span>Hypertension</span>
                    </div>
                </td>
                <td style="width: 25%;">
                    <div class="checkbox-row">
                        <input type="checkbox" <?php echo e($record->has_diabetes ? 'checked' : ''); ?>>
                        <span>Diabetes</span>
                    </div>
                </td>
                <td style="width: 25%;">
                    <div class="checkbox-row">
                        <input type="checkbox" <?php echo e($record->has_asthma ? 'checked' : ''); ?>>
                        <span>Asthma:</span>
                    </div>
            ...
            <tr>
                <td colspan="4">
                    <strong>Others:</strong> <?php echo e($record->other_medical_history); ?>
            ...
            <tr>
                ...
                <td rowspan="6" style="width: 15%; vertical-align: top;">
                    ...
                    <div>
                        ...
                        <?php echo e(\Carbon\Carbon::parse($record->last_menstrual_period)->format('m/d/Y')); ?>
        ...
        <table class="section-table">
            ...
            <tr>
                <td class="diagnosis-section"><?php echo e($record->diagnosis); ?></td>
            </tr>
        </table>
        ...
        <table class="section-table">
            <tr>
                <td class="field-label staff-section" style="width: 50%;">
                    ...
                    <?php echo e($record->nurse_on_duty); ?>

                </td>
                <td class="field-label staff-section" style="width: 50%;">
                    <strong>PHYSICIAN ON DUTY:</strong><br><br>
                    <?php echo e($record->physician_on_duty); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Uzi_Care\resources\views/patient-consultation-pdf.blade.php ENDPATH**/ ?>